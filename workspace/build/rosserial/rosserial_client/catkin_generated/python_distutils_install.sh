...
echo_and_run cd "/home/ubuntu/workspace/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/workspace/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/ubuntu/workspace/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
