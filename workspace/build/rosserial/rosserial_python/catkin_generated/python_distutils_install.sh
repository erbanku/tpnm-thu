...
echo_and_run cd "/home/ubuntu/workspace/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/workspace/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/ubuntu/workspace/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
