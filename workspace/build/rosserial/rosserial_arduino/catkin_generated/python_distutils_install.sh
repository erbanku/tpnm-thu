...
echo_and_run cd "/home/ubuntu/workspace/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/workspace/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/ubuntu/workspace/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
