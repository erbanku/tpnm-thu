...
echo_and_run cd "/home/ubuntu/workspace/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ubuntu/workspace/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/ubuntu/workspace/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
